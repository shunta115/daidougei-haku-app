-- Phase 1 apply (idempotent, additive).
-- Run this in Supabase SQL Editor AFTER 20260726–20260816 if those already exist.
-- Safe: no DROP TABLE, no DELETE of user rows, no fake performers.
-- Finder copies named '* 2.sql' must NOT be run.
